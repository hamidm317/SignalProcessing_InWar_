...
All codes in this repository is written without any access to internet, as a useless hobby.

I tried to write codes only using python basic operators (not any third-party module), other modules are ony used to compare the performance.
